...
const ImageInput = ({value, onChange, name, id, title, deleteFile}) => {
  return (
...

        {
            (
                ...
                ( typeof value !== 'string' ?
                     ...
                     :
                    <>
                       <img src={ApiConfig.domain + value} className='h-full rounded-md' />
                       <p className='text-primary-600 mt-3'>برای تغییر کلیک کنید</p>
                       </> )
                
                : 
                <>
                <p className='text-primary-600 text-9xl'><BiSolidImageAlt /></p>
